...
- German prose keeps its umlauts (ä, ö, ü, ß). Code identifiers and file names stay English.
- When configured durable memory is available, record the rationale and alternatives there as well as in the ADR so the decision survives future sessions.

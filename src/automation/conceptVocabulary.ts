 ...
 *
 * Scope decision (rebuild-native, not a 1:1 copy): neonika memory content is
 ...
 * (`summarizeConceptTagScriptCoverage`) — none have a neonika consumer (YAGNI).
 ...
 * their shape (`gateway/server`, `neonika`) because the split preserves

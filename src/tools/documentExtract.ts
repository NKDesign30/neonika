...
// binary formats (PDF/Docx) go through a pluggable provider seam so Neon Core's
...
/** A pluggable extractor for a binary format Neon Core does not parse natively. */

...
<body>
  <main class="app-shell">
    ...
    <section class="workspace">
      <header class="topbar">
        <div class="crumbbar"><span>Neon Core</span><span>›</span><span>Chaty Lab</span><span>›</span><strong id="viewTitle">${missionControlViewTitle(initialView)}</strong></div>
        <div class="top-tools">

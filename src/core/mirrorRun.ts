 ...
 *
 * The mirror stage wants the SAME prompt run against the previous runtime and Neon Core, with
 * latency measured and evidence written. Driving v3 live needs a running v3 process,
 * which is an operator decision — so this runtime drives only the Neon Core side live (via an

...
// is what lets the previous runtime be retired without taking Neon Core's memory with it.
//
...
async function handleMemorySearch(context: IRouteContext): Promise<void> {
  ...
  // NEON_MEMORY_DB_PATH (canonically neon-core data/semantic-memory.db, armed

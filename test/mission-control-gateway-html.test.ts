...
function createStatus(): INeonGatewayStatus {
  return {
    state: "ready",
    projectRoot: "/Users/operator/neon-projects/neon-core",
    runsPath: "/Users/operator/neon-projects/neon-core/state/gateway/runs.jsonl",
    runCount: 1,
    shadowRunCount: 1,
    completedCount: 1,
    failedCount: 0,
...
async function createTempProjectRoot(): Promise<string> {
  return await mkdtemp(join(tmpdir(), "neon-core-mission-control-html-"));
}
